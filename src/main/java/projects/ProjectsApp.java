...
public class ProjectsApp {
    ...
    /**
     * This method prints the operations, gets a user menu selection, 
     ...
     * then gets the user's menu selection from the console.
     */
    ...
    /**
     * Prints a prompt on the console and then gets the user's input 
     * from the console. Converts the input to an Integer.
     */
    ...
    /**
     * Prints a prompt on the console and then gets the user's input 
     * from the console. If the user enters nothing, {@code null} is returned.
     */
